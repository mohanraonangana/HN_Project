...
<c:forEach items="${mendata}"  var="men"> 
<tr> 
  <td><c:out value="${men.id}" /></td> 
  <td><c:out value="${men.name}" /></td> 
  <td><c:out value="${men.dateofbirth}" /></td> 
  <td><c:out value="${men.email}" /></td> 
  <td><c:out value="${men.occupation}" /></td> 
  <td><c:out value="${men.education}" /></td> 
  <td><c:out value="${men.certifications}" /></td> 
  <td><c:out value="${men.experience}" /></td> 
  <td><c:out value="${men.domain}" /></td> 
  <td>
    <a href='<c:url value="view?id=${men.id}"></c:url>' class="view-button">View</a>
  </td>
</tr> 
</c:forEach> 
</table> 
