...
<div class="card">
  <div class="card-item">ID : ${slot.id}</div>
  <div class="card-item">Name : ${slot.name}</div>
  <div class="card-item">EMAIL : ${slot.email}</div>
   <div class="card-item">CONTACT : ${slot.contact}</div>
   <div class="card-item">GENDER : ${slot.gender}</div>
    <div class="card-item">AGE : ${slot.age}</div>
    <div class="card-item">COMPLAINT : ${slot.complaint}</div>
  <div class="card-item">TIMESLOTS : ${slot.timeslots}</div>
  <div class="card-item">LOCATION : ${slot.location}</div>
