        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    <a href="mentorhome.jsp" class="nav-item nav-link active">Home</a>
                    <a href="mentorview.jsp" class="nav-item nav-link active">Customer views</a>
                     <a href="viewallbookings.jsp" class="nav-item nav-link active">SlotBooking List</a>
