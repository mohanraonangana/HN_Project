...
<br> 
<h3 align="center"><u>Slotes Booked</u></h3> 
...
<c:forEach items="${slotdata}"  var="slot"> 
<tr> 
  <td><c:out value="${slot.id}" /></td> 
  <td><c:out value="${slot.name}" /></td> 
  <td><c:out value="${slot.email}" /></td> 
  <td><c:out value="${slot.contact}" /></td> 
  <td><c:out value="${slot.gender}" /></td> 
   <td><c:out value="${slot.age}" /></td> 
  <td><c:out value="${slot.complaint}" /></td> 
  <td><c:out value="${slot.timeslots}" /></td> 
  <td><c:out value="${slot.location}" /></td> 
  
  <td>
    <a href='<c:url value="view?id=${slot.id}"></c:url>' class="view-button">View</a>
  </td>
</tr> 
</c:forEach> 
</table> 
