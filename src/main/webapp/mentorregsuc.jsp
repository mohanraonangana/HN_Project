<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <body>
        ...
        <!-- Navbar End -->
        <center>
        	<h1>Your request has been successfull sent.</h1>
        	<h4>After approval you will receive a mail with the credentails</h4>
        	<h4><a href="mentorlogin.jsp">Login if you are approved.</a></h4>
        </center>
        </body>
        </html>
